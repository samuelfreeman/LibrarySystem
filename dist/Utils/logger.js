...
exports.otpLogger = exports.stream = exports.logger = void 0;
// utils/logger.ts
...
const logger = winston_1.default.createLogger({
    ...
    transports: [
        ...
        new winston_1.default.transports.Console({
            format: winston_1.default.format.combine(winston_1.default.format.colorize(), // Only for console
...
const otpLogger = winston_1.default.createLogger({
    level: "info",
    format: winston_1.default.format.combine(winston_1.default.format.timestamp(), winston_1.default.format.printf(({ level, message, timestamp }) => {
        const msg = typeof message === "object" ? JSON.stringify(message, null, 2) : message;
        return `[${timestamp}] ${level}: ${msg}`;
    ...
    transports: [
        new winston_1.default.transports.File({ filename: path_1.default.join(logDir, "otp.log") }),
    ],
});
exports.otpLogger = otpLogger;
